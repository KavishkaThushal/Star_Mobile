...
function Appointment() {
  ...
  const defaultDates = appointments.map(
    (appointment) => appointment.appointDate
  );
            ...
            <div className="appointment-form">
              ...
              <span className="form-row">
                <span>
                  ...
                  />
                  {errors.appointDate && (
                    <p className="error-text">{errors.appointDate}</p>
                  )}
                </span>
              </span>
              <div className="relative flex flex-col mb-2 w-1/2 items-center">
                {/* Date pickers */}
              </div>
