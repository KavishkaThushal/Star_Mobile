    ...
    return (
        <div className='home-services'>
            <div className='home-services-description'>
                <p className='home-services-title'>We offer a full range of smartphone services</p>
                <div className='home-service-title-line'></div>
                <p className='home-services-txt'>Overcome faithful endless salvation enlightenment
                    salvation overcome pious mercifulascetic madness holiest joy passion zarathustra suicide overcome snare.</p>
                <div className='home-services-type'>
                    ...
                    <div className='home-services-right-type'>
                        ...
                        <div className='home-service'>
                            ...
                            <p className='home-service-description'>Ear Phone Jack Malfunctions</p>
                        </div>
                    </div>
                </div>
            ...
            <div className='home-service-image-slider'>
               <img src={mobileSwiperImg} className='service-image-slider'>
