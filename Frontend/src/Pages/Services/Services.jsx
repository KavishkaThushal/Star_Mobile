import './Services.css';
import { FaClock, FaMobile, FaCog, FaWrench } from 'react-icons/fa';
      ...
      <section className="our-services">
        ...
        <div className="service-items">
          <div className="service-item">
            <img src="/path-to-smartphone-icon.png" alt="Smartphone" />
            <h3>SMARTPHONE REPAIR</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
          </div>
          <div className="service-item">
            <img src="/path-to-tablet-icon.png" alt="Tablet" />
            <h3>TABLET REPAIR</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
          </div>
          <div className="service-item">
            <img src="/path-to-computer-icon.png" alt="Computer" />
